...
public class NXTChain {
    ...
    public static NXTWallet walletA; //Ví A
    public static NXTWallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new NXTWallet();
        walletB = new NXTWallet();
        NXTWallet coinbase = new NXTWallet();
